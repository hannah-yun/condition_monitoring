%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [vEBIC,vdist,vbests,vt,bestD] = DL_omp1_simulation_2(vibdata,nu,N,facn,vs)
    ...
    Yinit = vibdata(:,1:N+1); 
    [~,bestD,~,~] = one_segment_omp1(Yinit,vs,n,no_init);
    refD = bestD;
    ...
    for exp = 1:nu
        ...
        [vEBIC(exp),vdist(exp),bestD,vbests(exp),~] = two_segment_omp1(Yinit,vs,bestD,refD);
        vt(exp) = toc;
        if mod(exp, 50) == 0
            fprintf('Iter: %d\n', exp);
        end 
...
% Local functions
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [EBIC,bestD,bests,bestXn] = one_segment_omp1(Yinit,vs,n,no_init)
    %For L1-KSVD
    iters_L1 = 5;  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [EBIC,dist,bestD,bests,bestXn]=two_segment_omp1(Yinit,vs,D0,refD)
    %For L1-KSVD
    iters_L1 = 5;
