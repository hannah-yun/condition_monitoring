...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script for Case III for AKSVD1(Number of iterations are differnet depending 
% on Number of training signals)
% Data file
folder_path = cd;
...
for j = 1:length(facn)
    ...
    [vEBIC{j}, vdist{j}, vbests{j}, vt{j}, ~] = DL_AKSVD1_simulation(vibdata, nu, N, facn(j), vs);
end

% For Case III, it cannot be compared 2m with 3m due to the number of
